# ARS Pipeline Architecture (v3.13.0)
...
```mermaid
graph TD
    Pipeline[academic-pipeline<br/>orchestrator<br/>v3.13.0<br/>Agent Team: 5]
    Observer[collaboration_depth_agent<br/>observer · advisory only<br/>blocking: false]
    DR[deep-research<br/>13 agents<br/>v2.10.0<br/>+ corpus reader]
...
| Skill | Modes |
|---|---|
| `deep-research` v2.10.0 | full, quick, socratic, review, lit-review, three-way-scan, fact-check, systematic-review (8) |
